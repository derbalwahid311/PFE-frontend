...
export default function LargeNavbar(){
    ...
    return(
        <>
            ...
            <AnimatePresence>
                {open && 
                <motion.div className="overflow-hidden absolute top-0 left-0 right-0"  initial={{y:"-100vh" }} transition={{duration:0.3, ease:"easeInOut"}} animate={{y:"0vh"}} exit={{y:"-100vh",   transition:{duration:0.3}}}>
